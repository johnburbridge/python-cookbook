...
class DocumentFactory:
    ...
    @classmethod
    def create_document(cls, doc_type: DocumentType, title: str, author: str, content: str = "") -> Document:
        """
    ...
    @classmethod
    def register_document_type(cls, doc_type: DocumentType, document_class: Type[Document]) -> None:
        """
